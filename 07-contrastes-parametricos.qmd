...
a.  La hipótesis nula es $H_0: p=0.2$ y la hipótesis alternativa es $H_1: p> 0.2$. Si se dedice fijar aceptar la hipótesis nula con una proporción muestral menor de $0.25$ entonces se aceptaría la hipótesis ya que la proporción muestral observada es $0.22$.
